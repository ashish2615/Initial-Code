...
dist = cosmo.luminosity_distance(injection_parameters['redshift']) # Formula z = d / D_Lum. D_Lum = (1+z)^2*D_angular. D_Lum = sqrt(Lumi/(4*pi*flux))
